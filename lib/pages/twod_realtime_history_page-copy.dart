...
class _TwoDRealTimeHistoryPageState extends State<TwoDRealTimeHistoryPage>
  ...
  void initState() {
    ...
    //   fetch(dropdownvalue);
    // }
    Timer.periodic(Duration(seconds: 1), (Timer t) => RunTimeAuto());
  }
  ...
  Future<void> fetch(dropdownvalue) async {
    var response;
    if (dropdownvalue == 'Real Time') {
    ...
    if (response.success) {
      ...
      //   live2dlogList.where((item) => item.isReference).toList();
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                                  ...
                                                  setState(() {
                                                    ...
                                                    if (dropdownvalue ==
                                                      ...
                                                      for (int i = 0;
                                                        ...
                                                        if (list[i].section ==
                                                            dropdownvalue) {
                                                          // if(list[i].section == "12:01 PM" && list[i].isManual){
                                                          //   queryLive2dlog = QueryBuilder<ParseObject>(ParseObject('Live2dLog'))
                                                          //     ..whereEqualTo('section', dropdownvalue);
                                                          //   fetch(dropdownvalue);
                                                          //   return;
                                                          // }
                                                          // if(list[i].section != "12:01 PM" && list[i].isDone){
                                                          //   queryLive2dlog = QueryBuilder<ParseObject>(ParseObject('Live2dLog'))
                                                          //     ..whereEqualTo('section', dropdownvalue);
                                                          //   fetch(dropdownvalue);
                                                          //   return;
                                            ...
                                            //       else{
                                            //         for(int i=0; i<list.length;i++){
                                            //           if(list[i].section == dropdownvalue && list[i].isDone){
                                            //             queryLive2dlog = QueryBuilder<ParseObject>(ParseObject('Live2dLog'))
                                            //               ..whereEqualTo('section', dropdownvalue);
                                            //             fetch(dropdownvalue);
                                            //           }
